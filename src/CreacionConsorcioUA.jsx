      ...
      <div className="modal-body">
        <div className="list-group">
          ...
          <form className="row g-3">
            ...
            <div className="col-md-6">
              <label for="validationDefault03" className="form-label">Departamento</label>
              <select className="form-select" id="validationDefault03" required>
                <option selected disabled value="">Atlantico</option>
            ...
            <div className="col-md-6">
              <label for="validationDefault04" className="form-label">Ciudad o Municipio</label>
